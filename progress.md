...
- Adaptive range diagnostics: **182 / 182 leaf ranges complete**
- Current cursor: `complete`
- Repository results seen: **108,233**
- User search results seen: **12,137**
- Pages repositories found through users: **704**
- Identity users fully checked: **11,343**
- Unique repositories investigated: **90,817**
- Unique account owners investigated: **81,352**
- Candidates recorded: **1,255**
- Ranges stopped by result caps: **10**
- Workflow runs: **27**
- Last run (UTC): `2026-08-28T18:44:52.402609+00:00`
- Last API requests used: **1,477**
